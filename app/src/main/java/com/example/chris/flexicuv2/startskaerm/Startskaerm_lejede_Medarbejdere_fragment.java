...
public class Startskaerm_lejede_Medarbejdere_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Startskaerm_LejedeMedarbejdere_RecyclerviewAdapter mAdapter = new Startskaerm_LejedeMedarbejdere_RecyclerviewAdapter(getContext(), singleton.getMedarbejdere());
