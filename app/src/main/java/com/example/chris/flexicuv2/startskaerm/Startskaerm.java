...
public class Startskaerm extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, StartskaermPresenter.UpdateStartskærm {
    ...
    private StartskaermPresenter presenter;
    private Singleton singleton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.startskaerm_drawer_activity);
        presenter = new StartskaermPresenter(this);
        ...
        //drawer_top.setText("hellu");

        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
        navigationView.setNavigationItemSelectedListener(this);
        setTitle(singleton.getBruger().getVirksomhedsnavn());
