...
public class Lej_RecyclerviewAdapter extends RecyclerView.Adapter<Lej_RecyclerviewAdapter.ViewHolder>{

    private ArrayList<Medarbejder> mMedarbejder;
    private Context mContext;

    public Lej_RecyclerviewAdapter(Context mContext, ArrayList<Medarbejder> mMedarbejder) {
    ...
    @NonNull
    @Override
    public Lej_RecyclerviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.lej_listitem_ledig_arbejdskraft,viewGroup,false);
