...
public class Rediger_medarbejder_fragment_2_presenter {
    ...
    public Rediger_medarbejder_fragment_2_presenter(UpdateOpretMedarbejderFrag updateOpretMedarbejderFrag){
