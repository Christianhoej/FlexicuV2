 ...
 */public class opret_medarbejder_fragment_1 extends Fragment implements View.OnClickListener, Opret_Medarbejdere_Fragment1_Presenter.UpdateOpretMedarbejderFrag, RadioGroup.OnCheckedChangeListener {
     ...
     * A simple {@link Fragment} subclass.
     */
    public static class Medarbejder_Skaerm_fragment extends Fragment implements View.OnClickListener {
        ...
        Medarbejdere_skaerm.medarbejder_recyclerView_adapter adapter;
        ...
        private void fyldRecyclerView(View v){
            ...
            adapter = new Medarbejdere_skaerm.medarbejder_recyclerView_adapter(getContext()/*, navneTest, arbejdsområderTest*/);
