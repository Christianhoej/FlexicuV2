...
public class Startskaerm_UdlejedeMedarbejdere_RecyclerviewAdapter extends RecyclerView.Adapter<Startskaerm_UdlejedeMedarbejdere_RecyclerviewAdapter.ViewHolder>  {

    private ArrayList<Medarbejder> mMedarbejder;
    private Context mContext;

    public Startskaerm_UdlejedeMedarbejdere_RecyclerviewAdapter(Context mContext, ArrayList<Medarbejder> mMedarbejder) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.startskaerm_udlejede_medarbejdere,viewGroup,false);
