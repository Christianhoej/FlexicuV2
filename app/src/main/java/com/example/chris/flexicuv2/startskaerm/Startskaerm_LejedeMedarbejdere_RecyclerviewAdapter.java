...
public class Startskaerm_LejedeMedarbejdere_RecyclerviewAdapter extends RecyclerView.Adapter<Startskaerm_LejedeMedarbejdere_RecyclerviewAdapter.ViewHolder>  {

    private ArrayList<Medarbejder> mMedarbejder;
    private Context mContext;

    public Startskaerm_LejedeMedarbejdere_RecyclerviewAdapter(Context mContext, ArrayList<Medarbejder> mMedarbejder) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.startskaerm_lejede_medarbejdere,viewGroup,false);
